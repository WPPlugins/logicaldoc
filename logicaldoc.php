...
Plugin URI: http://wiki.logicaldoc.com/wiki/LogicalDOC_WordPress_Explorer
...
Author URI: http://www.logicaldoc.com
...
function ldoc_enqueue_scripts() {
    ...
    wp_register_script('validationEngine-en', plugins_url('assets/js/validator/jquery.validationEngine-en.js', __FILE__), array('jquery'), '2.5.5', true);
    wp_register_script('validationEngine', plugins_url('assets/js/validator/jquery.validationEngine.js', __FILE__), array('jquery'), '2.5.5', true);
