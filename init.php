        ...
        jQuery(document).ready(function ($) {
            ...
            $('.testBTN').click(function () {
                ...
                $.post(ajaxurl, data, function (response) {
                    ...
                    if ($('#message').length) {
                        $('#message').replaceWith('<div id="message" class="updated notice is-dismissible"><p><strong>' + response + '</strong>.</p><button type="button" class="notice-dismiss"><span class="screen-reader-text">Dismiss this notice.</span></button></div>');
                    } else {
                        $('<div id="message" class="updated notice is-dismissible"><p><strong>' + response + '</strong>.</p><button type="button" class="notice-dismiss"><span class="screen-reader-text">Dismiss this notice.</span></button></div>').insertAfter('h1');
                    }
                    removeOverlay();
